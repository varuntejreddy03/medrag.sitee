        ...
        <div className="container mx-auto px-4 lg:px-6 py-4 lg:py-5">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
            <div className="flex items-center gap-2 lg:gap-3">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl lg:rounded-2xl flex items-center justify-center shadow-lg">
                <Shield className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
              </div>
              <div>
                <h1 className="text-lg lg:text-2xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Clinical Assessment Report</h1>
                <p className="text-xs lg:text-base text-zinc-300 font-medium hidden sm:block">AI-Assisted Clinical Decision Support System</p>
              </div>
            </div>
            <div className="flex gap-2 lg:gap-3 overflow-x-auto">
              <button
                onClick={() => setShowChat(true)}
                className="px-3 lg:px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg lg:rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-200 flex items-center gap-1 lg:gap-2 font-medium text-xs lg:text-sm whitespace-nowrap"
              >
                <MessageCircle className="w-4 h-4 lg:w-5 lg:h-5" />
                <span className="hidden sm:inline">Clinical Consultation</span>
                <span className="sm:hidden">Chat</span>
              </button>
              <button
                onClick={() => router.push('/diagnosis/new')}
                className="px-3 lg:px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg lg:rounded-xl transition-all duration-200 flex items-center gap-1 lg:gap-2 font-medium text-xs lg:text-sm whitespace-nowrap"
              >
              ...
              <button
                onClick={() => router.push('/dashboard')}
                className="px-3 lg:px-4 py-2 bg-zinc-800/60 hover:bg-zinc-700/60 text-zinc-300 rounded-lg lg:rounded-xl transition-all duration-200 flex items-center gap-1 lg:gap-2 backdrop-blur text-xs lg:text-sm whitespace-nowrap"
              >
      ...
      <div className="container mx-auto px-4 py-6 lg:py-8 max-w-6xl">
        <div className="grid lg:grid-cols-3 gap-4 lg:gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 lg:space-y-6">
            {/* Symptoms */}
            <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/50 rounded-xl lg:rounded-2xl p-4 lg:p-6 report-animate">
              <h3 className="flex items-center gap-2 text-lg lg:text-xl font-semibold text-white mb-3 lg:mb-4">
                <Stethoscope className="w-5 h-5 lg:w-6 lg:h-6 text-blue-400" />
                Clinical Presentation
              </h3>
              <p className="text-zinc-300 leading-relaxed text-sm lg:text-lg">{diagnosis.symptoms}</p>
            </div>



            {/* Diagnosis */}
            <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/50 rounded-xl lg:rounded-2xl p-4 lg:p-8 report-animate">
